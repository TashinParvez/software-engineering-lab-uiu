...
# To Keep Browser Open Indefinitely    --------- other wise browser will close after wards
...
driver.get("http://www.google.com")  # To open the browser and go to the link (Open any website)
